...
import { machineService, fixedServicesService, materialService, maintenanceMaterialService } from '../services';
...
export class MaintenanceMaterialController {
    async getAll(_req: Request, res: Response, next: NextFunction) {
        try {
            const materials = await maintenanceMaterialService.getAll();
    ...
    async create(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const material = await maintenanceMaterialService.create(name, pricePerUnit, unit, description);
    ...
    async update(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const material = await maintenanceMaterialService.update(id as string, { name, pricePerUnit, unit, description });
    ...
    async delete(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            await maintenanceMaterialService.deactivate(id as string);

            res.json({
                success: true,
                data: { message: 'Maintenance material deactivated successfully' },
            });
        } catch (error) {
            next(error);
        }
...
export const maintenanceMaterialController = new MaintenanceMaterialController();
